...
class AudioCleanupActivity : BaseActivity<ActivityMediaCleanupBinding>(ActivityMediaCleanupBinding::inflate) {

    private val viewModel: AudioCleanupViewModel by viewModels()
    private val adapter by lazy { SectionCleanupAdapter() }

    override fun initView() {
        binding.tvTitle.text = getString(R.string.audio_cleanup)
        binding.tvEmptyTitle.text = getString(R.string.no_audio_cleanup)
        binding.tvEmptyDesc.text = getString(R.string.no_audio_cleanup_desc)
