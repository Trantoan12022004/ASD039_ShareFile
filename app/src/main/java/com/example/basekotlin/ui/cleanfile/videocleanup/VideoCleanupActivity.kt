package com.example.basekotlin.ui.cleanfile.videocleanup
...
class VideoCleanupActivity : BaseActivity<ActivityMediaCleanupBinding>(ActivityMediaCleanupBinding::inflate) {

    private val viewModel: VideoCleanupViewModel by viewModels()
    private val adapter by lazy { SectionCleanupAdapter() }

    override fun initView() {
        binding.tvTitle.text = getString(R.string.video_cleanup)
        binding.tvEmptyTitle.text = getString(R.string.no_video_cleanup)
        binding.tvEmptyDesc.text = getString(R.string.no_video_cleanup_desc)
